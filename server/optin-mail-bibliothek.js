...
/* eslint-disable */
// =====================================================================================
// Vorlagen der beiden Opt-in-Mails — Wort fuer Wort aus dem laufenden n8n-Workflow
// "AC - Lead Post Processor - Business Leads Quiz" (9RZdrLxfA8IRhd55).
//
// 🔴 DER RUMPF DIESER DATEI IST UNVERAENDERT. Alles zwischen dieser Kopfzeile und dem
// Export-Block am Ende ist zeichengleich mit
// docs/audits/c1-postprocessor-extrakt/bibliothek.js — und die ist per Pruefsumme
// (883c5aa78cec941e) als dieselbe Fassung belegt, die heute in n8n laeuft.
//
// Ein Test haelt das fest (scripts/tests/optin-mail-vorlagen.test.js): Weicht der Rumpf
// vom Extrakt ab, schlaegt er an. Wer hier etwas aendert, aendert die Mail, die heute
// wirklich verschickt wird — das soll man nicht versehentlich tun.
//
// Diese Datei wird derzeit von NIEMANDEM aufgerufen. Sie ist Schritt M1: die Vorlagen
// liegen im Repo und sind pruefbar, bevor der Versand umzieht (Strang M).
// Warum der Versand noch nicht umziehen kann: docs/plans/umsetzung-m-mailweg-ins-projekt.md §10
// — die alte Contacts-Route antwortet leer, das Quiz erfaehrt den aufgeloesten Berater nicht.
//
// eslint ist fuer diese Datei abgeschaltet: Sie ist eine woertliche Uebernahme, kein
// eigener Quelltext. Formatierungsregeln darauf anzuwenden hiesse, den Rumpf zu aendern.
// =====================================================================================
...
// Ab hier NEU (nicht Teil des Extrakts): der Export-Block.
// Der Driftwaechter kennt diese Grenze und prueft nur den Rumpf darueber.
module.exports = {
  buildLeadModel,
  buildCoachEmailHtml,
  buildCoachEmailText,
  buildPremiumLeadEmailHtml,
  buildPremiumLeadEmailText,
  getLocalizedLeadEmailPresentation,
  escapeHtml,
};
