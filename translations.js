(function () {
  ...
  const de = buildTranslations({
    static: {
      ...
      result_cta_btn: 'Dein Potenzial nutzen! → Video ansehen (3 Min)',
  ...
  const it = buildTranslations({
    static: {
      ...
      result_cta_btn: 'Sfrutta il tuo potenziale! → Guarda il video (3 min)',
  ...
  const en = buildTranslations({
    static: {
      ...
      result_cta_btn: 'Unlock your potential! → Watch the video (3 min)',
  ...
  const fr = buildTranslations({
    static: {
      ...
      result_cta_btn: 'Exploite ton potentiel ! → Regarder la vidéo (3 min)',
  ...
  const ru = buildTranslations({
    static: {
      ...
      result_cta_btn: 'Используй свой потенциал! → Смотреть видео (3 мин)',
  ...
  const hu = buildTranslations({
    static: {
      ...
      result_cta_btn: 'Használd ki a potenciálod! → Nézd meg a videót (3 perc)',
