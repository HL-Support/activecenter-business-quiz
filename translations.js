(function () {
  ...
  const it = buildTranslations({
    static: {
      ...
      result_cta_btn: 'Inizia la parte 1 →',
  ...
  const fr = buildTranslations({
    static: {
      ...
      result_cta_btn: 'Commencer la partie 1 →',
  ...
  const hu = buildTranslations({
    static: {
      ...
      result_cta_btn: '1. rész indítása →',
