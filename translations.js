(function () {
  ...
  const de = buildTranslations({
    static: {
      ...
      result_cta_btn: 'Was steckt hinter deinem Code? → Video ansehen (3 Min)',
      result_restart_btn: 'Quiz neu starten',
      result_snapshot_heading: 'Deine Auswertung auf einen Blick',
      result_snapshot_type_label: 'Dein Erfolgstyp',
      result_snapshot_energy_label: 'Deine stärkste Energie',
      result_snapshot_blocker_label: 'Dein innerer Blocker',
      result_snapshot_access_label: 'Dein nächster Schritt',
      result_snapshot_energy_freedom: 'Freiheit durch Selbstbestimmung',
      result_snapshot_energy_impact: 'Wirkung durch echte Beziehungen',
      result_snapshot_energy_security: 'Sicherheit durch klare Schritte',
      result_snapshot_energy_growth: 'Wachstum durch ein lernbares System',
      result_snapshot_blocker_fallback: 'dein nächster klarer Schritt',
      result_snapshot_access_text: '3 kurze Schritte zu deiner Einschätzung',
      result_video_access_note:
        'Dein Ergebnis ist der Startpunkt. Die nächsten 3 kurzen Schritte zeigen dir jetzt, ob daraus ein echter Weg für dich werden kann: erst Klarheit, dann System, dann echte Erfahrungen.',
      ...
      optin_badge: 'Auswertung bereit',
      optin_h2_line1: 'Dein Erfolgscode',
      optin_h2_line2: 'ist berechnet.',
      optin_body:
        'In deinen Antworten zeigt sich ein klares Muster. Gleich siehst du, welcher Erfolgstyp du bist, was dich antreibt und welcher nächste Schritt am besten zu dir passt.',
      optin_teaser_1: 'Dein Erfolgstyp',
      optin_teaser_2: 'Deine stärkste Energie',
      optin_teaser_3: 'Dein innerer Blocker',
      optin_teaser_4: 'Dein Zugang zu den 3 Videos',
      optin_form_badge: 'Letzter Schritt',
      optin_form_heading: 'Öffne deine Auswertung',
      optin_form_subheading: 'Die Zusammenfassung bekommst du zusätzlich per E-Mail.',
      ...
      video_2_title: 'Teil 2: Das System dahinter',
      video_2_sub:
        'Du siehst, welche Schritte dazugehören, was dich unterstützt und woran du erkennst, ob dieser Weg zu dir passt.',
      video_3_title: 'Teil 3: Echte Erfahrungen',
      video_3_sub:
        'Menschen wie du, was sie erlebt haben und was sich in ihrem Leben verändert hat.',
      video_personal_line: 'Für dich als {profile} mit Fokus {aspiration}: Achte besonders darauf, ob du dich in diesem ersten Punkt wiedererkennst.',
      video_transition_1: 'Teil 1 ist erledigt. Jetzt kommt der wichtigste Punkt: Wie wird aus Interesse ein klares System?',
      video_transition_2: 'Du kennst jetzt den Aufbau. In Teil 3 siehst du, wie sich das bei echten Menschen anfühlt.',
      video_extra_3: 'Schau nicht nach Perfektion, sondern nach Wiedererkennung: Welche Erfahrung klingt nach deinem nächsten Schritt?',
      video_btn_next_2: 'Teil 2: Das System verstehen →',
      video_btn_next_3: 'Teil 3: Echte Erfahrungen ansehen →',
      video_counter: 'Video',
  ...
  const it = buildTranslations({
    static: {
      ...
      result_cta_btn: "Cosa c'è dietro il tuo codice? → Guarda il video (3 min)",
      result_restart_btn: 'Ricomincia il quiz',
      result_snapshot_heading: 'La tua analisi in sintesi',
      result_snapshot_type_label: 'Il tuo tipo di successo',
      result_snapshot_energy_label: 'La tua energia più forte',
      result_snapshot_blocker_label: 'Il tuo blocco interiore',
      result_snapshot_access_label: 'Il tuo prossimo passo',
      result_snapshot_energy_freedom: "Libertà attraverso l'autodeterminazione",
      result_snapshot_energy_impact: 'Impatto attraverso relazioni autentiche',
      result_snapshot_energy_security: 'Sicurezza attraverso passi chiari',
      result_snapshot_energy_growth: 'Crescita attraverso un sistema apprendibile',
      result_snapshot_blocker_fallback: 'il tuo prossimo passo chiaro',
      result_snapshot_access_text: '3 brevi passi per la tua valutazione',
      result_video_access_note:
        'Il tuo risultato è il punto di partenza. I prossimi 3 brevi passi ti mostrano se può diventare un percorso reale per te: prima chiarezza, poi sistema, poi esperienze vere.',
      ...
      optin_badge: 'Risultato pronto',
      optin_h2_line1: 'Il tuo codice',
      optin_h2_line2: 'è stato calcolato.',
      optin_body:
        'Nelle tue risposte si vede uno schema chiaro. Tra poco scoprirai che tipo di successo sei, cosa ti guida e qual è il prossimo passo più adatto a te.',
      optin_teaser_1: 'Il tuo tipo di successo',
      optin_teaser_2: 'La tua energia più forte',
      optin_teaser_3: 'Il tuo blocco interiore',
      optin_teaser_4: "L'accesso ai 3 video",
      optin_form_badge: 'Ultimo passo',
      optin_form_heading: 'Apri la tua analisi',
      optin_form_subheading: 'Riceverai anche il riepilogo via e-mail.',
      ...
      video_2_title: 'Parte 2: Il sistema dietro',
      video_2_sub:
        'Vedrai quali passi fanno parte del percorso, cosa ti sostiene e come capire se questa strada fa per te.',
      video_3_title: 'Parte 3: Esperienze reali',
      video_3_sub: 'Persone come te, cosa hanno vissuto e cosa è cambiato nella loro vita.',
      video_personal_line: 'Per te come {profile}, con focus su {aspiration}: fai attenzione se ti riconosci in questo primo punto.',
      video_transition_1: 'La parte 1 è completata. Ora arriva il punto più importante: come può un interesse diventare un sistema chiaro?',
      video_transition_2: 'Ora conosci la struttura. Nella parte 3 vedrai come si sente tutto questo nella vita reale.',
      video_extra_3: 'Non cercare la perfezione, ma il riconoscimento: quale esperienza somiglia al tuo prossimo passo?',
      video_btn_next_2: 'Parte 2: capire il sistema →',
      video_btn_next_3: 'Parte 3: guarda esperienze reali →',
      video_counter: 'Video',
  ...
  const en = buildTranslations({
    static: {
      ...
      result_cta_btn: "What's behind your code? → Watch the video (3 min)",
      result_restart_btn: 'Restart quiz',
      result_snapshot_heading: 'Your analysis at a glance',
      result_snapshot_type_label: 'Your success type',
      result_snapshot_energy_label: 'Your strongest energy',
      result_snapshot_blocker_label: 'Your inner blocker',
      result_snapshot_access_label: 'Your next step',
      result_snapshot_energy_freedom: 'Freedom through self-direction',
      result_snapshot_energy_impact: 'Impact through real relationships',
      result_snapshot_energy_security: 'Security through clear steps',
      result_snapshot_energy_growth: 'Growth through a learnable system',
      result_snapshot_blocker_fallback: 'your next clear step',
      result_snapshot_access_text: '3 short steps to your assessment',
      result_video_access_note:
        'Your result is the starting point. The next 3 short steps now show you whether this can become a real path for you: first clarity, then the system, then real experiences.',
      ...
      optin_badge: 'Result ready',
      optin_h2_line1: 'Your success code',
      optin_h2_line2: 'has been calculated.',
      optin_body:
        'Your answers reveal a clear pattern. In a moment you will see which success type you are, what drives you, and which next step fits you best.',
      optin_teaser_1: 'Your success type',
      optin_teaser_2: 'Your strongest energy',
      optin_teaser_3: 'Your inner blocker',
      optin_teaser_4: 'Your access to the 3 videos',
      optin_form_badge: 'Final step',
      optin_form_heading: 'Unlock your analysis',
      optin_form_subheading: 'You will also receive the summary by email.',
      ...
      video_2_title: 'Part 2: The system behind it',
      video_2_sub:
        'You will see which steps are part of it, what supports you, and how to recognize whether this path fits you.',
      video_3_title: 'Part 3: Real experiences',
      video_3_sub: 'People like you, what they experienced and what changed in their lives.',
      video_personal_line: 'For you as {profile}, with a focus on {aspiration}: pay close attention to whether you recognize yourself in this first point.',
      video_transition_1: 'Part 1 is done. Now comes the most important point: how does interest turn into a clear system?',
      video_transition_2: 'You now know the structure. In part 3 you will see how this feels with real people.',
      video_extra_3: 'Do not look for perfection, but for recognition: which experience sounds like your next step?',
      video_btn_next_2: 'Part 2: Understand the system →',
      video_btn_next_3: 'Part 3: Watch real experiences →',
      video_counter: 'Video',
  ...
  const fr = buildTranslations({
    static: {
      ...
      result_cta_btn: 'Que cache ton code ? → Regarder la vidéo (3 min)',
      result_restart_btn: 'Recommencer le quiz',
      result_snapshot_heading: "Ton analyse en un coup d'œil",
      result_snapshot_type_label: 'Ton type de réussite',
      result_snapshot_energy_label: 'Ton énergie la plus forte',
      result_snapshot_blocker_label: 'Ton blocage intérieur',
      result_snapshot_access_label: 'Ta prochaine étape',
      result_snapshot_energy_freedom: "Liberté par l'autodétermination",
      result_snapshot_energy_impact: 'Impact par de vraies relations',
      result_snapshot_energy_security: 'Sécurité par des étapes claires',
      result_snapshot_energy_growth: 'Croissance par un système apprenable',
      result_snapshot_blocker_fallback: 'ta prochaine étape claire',
      result_snapshot_access_text: '3 courtes étapes pour ton évaluation',
      result_video_access_note:
        'Ton résultat est le point de départ. Les 3 prochaines courtes étapes te montrent maintenant si cela peut devenir un vrai chemin pour toi : d’abord la clarté, puis le système, puis des expériences réelles.',
      ...
      optin_badge: 'Analyse prête',
      optin_h2_line1: 'Ton code de réussite',
      optin_h2_line2: 'est calculé.',
      optin_body:
        'Tes réponses montrent un schéma clair. Dans un instant, tu verras quel type de réussite tu es, ce qui te motive et quelle prochaine étape te correspond le mieux.',
      optin_teaser_1: 'Ton type de réussite',
      optin_teaser_2: 'Ton énergie la plus forte',
      optin_teaser_3: 'Ton blocage intérieur',
      optin_teaser_4: 'Ton accès aux 3 vidéos',
      optin_form_badge: 'Dernière étape',
      optin_form_heading: 'Ouvre ton analyse',
      optin_form_subheading: 'Tu recevras aussi le résumé par e-mail.',
      ...
      video_2_title: 'Partie 2 : Le système derrière',
      video_2_sub:
        'Tu verras quelles étapes en font partie, ce qui te soutient et comment reconnaître si ce chemin te correspond.',
      ...
      video_personal_line: 'Pour toi en tant que {profile}, avec le focus {aspiration} : observe surtout si tu te reconnais dans ce premier point.',
      video_transition_1: 'La partie 1 est terminée. Maintenant vient le point le plus important : comment transformer l’intérêt en un système clair ?',
      video_transition_2: 'Tu connais maintenant la structure. Dans la partie 3, tu vois ce que cela donne chez de vraies personnes.',
      video_extra_3: 'Ne cherche pas la perfection, mais la reconnaissance : quelle expérience ressemble à ta prochaine étape ?',
      video_btn_next_2: 'Partie 2 : comprendre le système →',
      video_btn_next_3: 'Partie 3 : voir de vraies expériences →',
      video_counter: 'Vidéo',
  ...
  const ru = buildTranslations({
    static: {
      ...
      result_cta_btn: 'Что стоит за твоим кодом? → Смотреть видео (3 мин)',
      result_restart_btn: 'Начать тест заново',
      result_snapshot_heading: 'Твоя аналитика в одном взгляде',
      result_snapshot_type_label: 'Твой тип успеха',
      result_snapshot_energy_label: 'Твоя самая сильная энергия',
      result_snapshot_blocker_label: 'Твой внутренний блок',
      result_snapshot_access_label: 'Твой следующий шаг',
      result_snapshot_energy_freedom: 'Свобода через самостоятельность',
      result_snapshot_energy_impact: 'Влияние через настоящие отношения',
      result_snapshot_energy_security: 'Безопасность через ясные шаги',
      result_snapshot_energy_growth: 'Рост через понятную систему',
      result_snapshot_blocker_fallback: 'твой следующий ясный шаг',
      result_snapshot_access_text: '3 коротких шага к твоей оценке',
      result_video_access_note:
        'Твой результат — это отправная точка. Следующие 3 коротких шага покажут, может ли из этого получиться реальный путь для тебя: сначала ясность, затем система, затем реальные истории.',
      ...
      optin_badge: 'Результат готов',
      optin_h2_line1: 'Твой код успеха',
      optin_h2_line2: 'рассчитан.',
      optin_body:
        'В твоих ответах виден четкий паттерн. Сейчас ты увидишь, какой у тебя тип успеха, что тобой движет и какой следующий шаг подходит тебе лучше всего.',
      optin_teaser_1: 'Твой тип успеха',
      optin_teaser_2: 'Твоя самая сильная энергия',
      optin_teaser_3: 'Твой внутренний блок',
      optin_teaser_4: 'Твой доступ к 3 видео',
      optin_form_badge: 'Последний шаг',
      optin_form_heading: 'Открой свою аналитику',
      optin_form_subheading: 'Дополнительно ты получишь краткое резюме по e-mail.',
      ...
      video_2_title: 'Часть 2: Система за этим',
      video_2_sub: 'Ты увидишь, какие шаги входят в путь, что тебя поддерживает и как понять, подходит ли тебе этот путь.',
      video_3_title: 'Часть 3: Реальные опыты',
      video_3_sub: 'Люди как ты, что они испытали и что изменилось в их жизни.',
      video_personal_line: 'Для тебя как {profile}, с фокусом на «{aspiration}»: обрати внимание, узнаёшь ли ты себя в этом первом пункте.',
      video_transition_1: 'Часть 1 завершена. Теперь самый важный момент: как из интереса появляется понятная система?',
      video_transition_2: 'Теперь ты знаешь структуру. В части 3 ты увидишь, как это выглядит у реальных людей.',
      video_extra_3: 'Не ищи идеальность, ищи узнавание: какая история похожа на твой следующий шаг?',
      video_btn_next_2: 'Часть 2: понять систему →',
      video_btn_next_3: 'Часть 3: посмотреть реальные истории →',
      video_counter: 'Видео',
  ...
  const hu = buildTranslations({
    static: {
      ...
      result_cta_btn: 'Mi áll a kódod mögött? → Nézd meg a videót (3 perc)',
      ...
      result_snapshot_access_label: 'A következő lépésed',
      ...
      result_snapshot_access_text: '3 rövid lépés a saját döntésedhez',
      result_video_access_note:
        'Az eredményed a kiindulópont. A következő 3 rövid lépés megmutatja, lehet-e ebből valódi út számodra: először tisztánlátás, aztán rendszer, aztán valódi tapasztalatok.',
      ...
      video_2_title: '2. rész: A mögötte lévő rendszer',
      video_2_sub:
        'Látni fogod, milyen lépések tartoznak hozzá, mi támogat, és miből ismered fel, hogy ez az út illik-e hozzád.',
      ...
      video_personal_line: 'Neked, mint {profile}, {aspiration} fókusszal: figyeld meg különösen, hogy felismered-e magad ebben az első pontban.',
      video_transition_1: 'Az 1. rész kész. Most jön a legfontosabb pont: hogyan lesz az érdeklődésből tiszta rendszer?',
      video_transition_2: 'Most már ismered a felépítést. A 3. részben meglátod, hogyan néz ki ez valódi embereknél.',
      video_extra_3: 'Ne a tökéletességet keresd, hanem a felismerést: melyik tapasztalat hasonlít a te következő lépésedre?',
      video_btn_next_2: '2. rész: a rendszer megértése →',
      video_btn_next_3: '3. rész: valódi tapasztalatok megtekintése →',
      video_counter: 'Videó',
