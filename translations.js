(function () {
  ...
  const de = buildTranslations({
    static: {
      ...
      result_snapshot_access_label: 'Dein nächster Zugang',
      ...
      result_snapshot_access_text: '3 kurze Videos, passend zu deinem Typ',
      result_video_access_note:
        'Dein Zugang ist freigeschaltet. Im nächsten Schritt zeigen wir dir, welches System zu deinem Typ und deinem Ziel passt.',
  ...
  const it = buildTranslations({
    static: {
      ...
      result_snapshot_access_label: 'Il tuo prossimo accesso',
      ...
      result_snapshot_access_text: '3 brevi video, adatti al tuo tipo',
      result_video_access_note:
        'Il tuo accesso è sbloccato. Nel prossimo passo ti mostriamo quale sistema si adatta al tuo tipo e al tuo obiettivo.',
  ...
  const en = buildTranslations({
    static: {
      ...
      result_snapshot_access_label: 'Your next access',
      ...
      result_snapshot_access_text: '3 short videos matched to your type',
      result_video_access_note:
        'Your access is unlocked. In the next step, we show you which system fits your type and your goal.',
  ...
  const fr = buildTranslations({
    static: {
      ...
      result_snapshot_access_label: 'Ton prochain accès',
      ...
      result_snapshot_access_text: '3 courtes vidéos adaptées à ton type',
      result_video_access_note:
        "Ton accès est débloqué. À l'étape suivante, nous te montrons quel système correspond à ton type et à ton objectif.",
  ...
  const ru = buildTranslations({
    static: {
      ...
      result_snapshot_access_label: 'Твой следующий доступ',
      ...
      result_snapshot_access_text: '3 коротких видео под твой тип',
      result_video_access_note:
        'Твой доступ открыт. На следующем шаге мы покажем, какая система подходит твоему типу и цели.',
