...
const LEAD_EMAIL_I18N = {
  de: {
    subject: 'Dein Erfolgs-Code ist da und Video 1 (3 Min) wartet',
    preheader: 'Dein pers\u00f6nlicher Zugang zu den 3 Videos ist bereit. Video 1 dauert nur 3 Minuten.',
    greeting: 'Hi',
    intro: 'dein Erfolgs-Code ist da und dein pers\u00f6nlicher Zugang ist bereit.',
    resultLabel: 'Dein Erfolgs-Code',
    elementLabel: 'Element',
    resumeIntro: 'Hier ist dein pers\u00f6nlicher Zugang zu den 3 Videos. Video 1 dauert 3 Minuten.',
    ctaLabel: 'Video 1 ansehen (3 Min)',
  ...
  it: {
    subject: 'Il tuo codice del successo \u00e8 qui e il video 1 (3 min) ti aspetta',
    preheader: 'Il tuo accesso personale ai 3 video \u00e8 pronto. Il video 1 dura solo 3 minuti.',
    greeting: 'Ciao',
    ...
    resumeIntro: 'Ecco il tuo accesso personale ai 3 video. Il video 1 dura 3 minuti.',
    ctaLabel: 'Guarda il video 1 (3 min)',
  ...
  en: {
    subject: 'Your success code is here and video 1 (3 min) is waiting',
    preheader: 'Your personal access to the 3 videos is ready. Video 1 takes just 3 minutes.',
    greeting: 'Hi',
    intro: 'your success code is ready and your personal access is waiting for you.',
    resultLabel: 'Your success code',
    elementLabel: 'Element',
    resumeIntro: 'Here is your personal access to the 3 videos. Video 1 takes 3 minutes.',
    ctaLabel: 'Watch video 1 (3 min)',
  ...
  fr: {
    subject: 'Votre code du succ\u00e8s est l\u00e0 et la vid\u00e9o 1 (3 min) vous attend',
    preheader: 'Votre acc\u00e8s personnel aux 3 vid\u00e9os est pr\u00eat. La vid\u00e9o 1 ne dure que 3 minutes.',
    greeting: 'Bonjour',
    ...
    resumeIntro: 'Voici votre acc\u00e8s personnel aux 3 vid\u00e9os. La vid\u00e9o 1 dure 3 minutes.',
    ctaLabel: 'Regarder la vid\u00e9o 1 (3 min)',
  ...
  ru: {
    subject: '\u0412\u0430\u0448 \u043a\u043e\u0434 \u0443\u0441\u043f\u0435\u0445\u0430 \u0433\u043e\u0442\u043e\u0432, \u0438 \u0432\u0438\u0434\u0435\u043e 1 (3 \u043c\u0438\u043d) \u0436\u0434\u0451\u0442 \u0432\u0430\u0441',
    preheader: '\u0412\u0430\u0448 \u043b\u0438\u0447\u043d\u044b\u0439 \u0434\u043e\u0441\u0442\u0443\u043f \u043a 3 \u0432\u0438\u0434\u0435\u043e \u0433\u043e\u0442\u043e\u0432. \u0412\u0438\u0434\u0435\u043e 1 \u0434\u043b\u0438\u0442\u0441\u044f \u0432\u0441\u0435\u0433\u043e 3 \u043c\u0438\u043d\u0443\u0442\u044b.',
    greeting: '\u0417\u0434\u0440\u0430\u0432\u0441\u0442\u0432\u0443\u0439\u0442\u0435',
    intro: '\u0432\u0430\u0448 \u043a\u043e\u0434 \u0443\u0441\u043f\u0435\u0445\u0430 \u0433\u043e\u0442\u043e\u0432, \u0438 \u0432\u0430\u0448 \u043f\u0435\u0440\u0441\u043e\u043d\u0430\u043b\u044c\u043d\u044b\u0439 \u0434\u043e\u0441\u0442\u0443\u043f \u0443\u0436\u0435 \u0436\u0434\u0451\u0442 \u0432\u0430\u0441.',
    resultLabel: '\u0412\u0430\u0448 \u043a\u043e\u0434 \u0443\u0441\u043f\u0435\u0445\u0430',
    elementLabel: '\u042d\u043b\u0435\u043c\u0435\u043d\u0442',
    resumeIntro: '\u0412\u043e\u0442 \u0432\u0430\u0448 \u043b\u0438\u0447\u043d\u044b\u0439 \u0434\u043e\u0441\u0442\u0443\u043f \u043a 3 \u0432\u0438\u0434\u0435\u043e. \u0412\u0438\u0434\u0435\u043e 1 \u0434\u043b\u0438\u0442\u0441\u044f 3 \u043c\u0438\u043d\u0443\u0442\u044b.',
    ctaLabel: '\u0421\u043c\u043e\u0442\u0440\u0435\u0442\u044c \u0432\u0438\u0434\u0435\u043e 1 (3 \u043c\u0438\u043d)',
...
function buildPremiumLeadEmailHtml(model) {
  ...
  const bodyHtml = [
    ...
    `<p style="margin:0 0 14px 0;font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:1.65;color:#2D2D2D;">${escapeHtml(copy.resumeIntro)}</p>`,
    `<div style="margin:0 0 28px 0;text-align:center;">${buildBulletproofButton(model.video_access_url, copy.ctaLabel, presentation.accent, presentation.buttonText)}</div>`,
    buildLeadResultCard(
      {
        ...model,
...
// AP4.5 (Conversion-Plan 2026-09-01): Ein Resume-Token-Fehler darf den Versand
