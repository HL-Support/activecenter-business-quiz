...
| A4d | 🔴 **Zwei Lücken im Übersetzer, vor allem anderen zu schliessen** | Der Übersetzer wurde gegen die **echten** 14 Abfragen des Kalkulators laufen gelassen: 12 gehen durch, **zwei nicht** — und beide treffen die Kontaktliste (api/contacts.js:1138):  → „Unbekannter Operator",  → „offset wird nicht unterstuetzt". Erweiterung gehört ins **Quiz-Repo**, mit Tests |
