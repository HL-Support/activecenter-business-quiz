export default function InfoPage() {
  const phases = [
    ...
    },
    {
      ...
      emails: [
        { id: '34', label: 'C1', when: '24h nach V2', variant: 'Single', condition: 'Kein V3 gesehen', desc: 'Testimonial-Email: Video 3 als wichtigsten und persönlichsten Schritt positionieren. Zitat eines ähnlichen Typs.' },
  ...
  return (
    <div style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif', background: '#f9fafb', minHeight: '100vh' }}>
      ...
      <div style={{ background: '#111827', color: '#fff', padding: '14px 32px', display: 'flex', alignItems: 'center', gap: '20px' }}>
        ...
        <span style={{ marginLeft: 'auto', color: '#6b7280', fontSize: '12px' }}>82 Templates · 7 Phasen · 6 Emails pro Aktivierungsphase</span>
      </div>
